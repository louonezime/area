...
class _MainPageState extends State<MainPage> {
  ...
  Future<void> _handleSubmit(String email, String password) async {
    final endpoint = await getAPIEndpointPath('login');
    ...
    try {
      ...
      log('Unauthorized.', time: DateTime.now());
      if (context.mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          errorSnackBar(
            context: context,
            content: AppLocalizations.of(context)!.loginError401,
          ),
        );
      }
      return;
            ...
            child: Column(
              children: [
                ...
                AuthForm(
                  ...
                  onSubmit: (email, password) => _handleSubmit(email, password),
                  ...
                  child: Wrap(
                    children: [
                      SelectableText.rich(
                        TextSpan(
                          text:
                              '${AppLocalizations.of(context)!.newToArea} ', // 'New to AREA? '
                          ...
                          children: [
                            TextSpan(
                              text:
                                  '${AppLocalizations.of(context)!.signUpHere}.', // 'Sign up here.'
                              style: Theme.of(context)
                                  .textTheme
                                  .headlineLarge
                                  ?.copyWith(
